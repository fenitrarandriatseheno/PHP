...
<body>
    <h4>Reservation</h4>
    <a href="Listage-place.php"><button type="button" class="listage">Affichage place libre</button></a>
       <div>
    <form action="" method="post">
        ...
        <?php
            ...
            $place = ""; // Initialisation de la variable pour éviter l'erreur
            ...
            <button type="submit" id="choix_place"><a href="place.php">Choix place </a></button>
        </div>
        
        <div>
            <label for="" class="date-reserv">Date de Reservation :</label>
            <input type="text" name="datetime" id="datetime"><br><br>
        </div>
        ...
        <div>
            ...
            <input type="text" name="Montant" id="Montant" oninput="calculerReste();" value="<?php echo isset($Montant) ? $Montant : ''; ?>"><br><br>
        </div>
        ...
        <div>
            ...
            <a href="../Acceuil.php"><button type="button" class="Retour" name="Retour">Retour</button></a><br><br>
        </div>
